...
class UserControllerTest {
        ...
        void shouldReturn400WhenCreatingUserWithDuplicateEmail() throws Exception {
                ...
                when(userService.createUser(any(UserDto.class)))
                                .thenThrow(new IllegalArgumentException(
                                                "User with email already exists: john.doe@example.com"));
        ...
        @Test
        @DisplayName("Should update user successfully via PUT /api/users/{id}")
        void shouldUpdateUserSuccessfully() throws Exception {
                ...
                mockMvc.perform(put("/api/users/1")
                                ...
                                .andExpect(jsonPath("$.monthlyIncome").value(6000.0));
        ...
        @Test
        @DisplayName("Should delete user successfully via DELETE /api/users/{id}")
